    ...
    def __init__(self, value=''):
        while True:
            ...
            if value:
                ...
                self.values = self.interface.bot_input("Phones(+48......... or +38..........) (multiple phones can be added with space between them. +48 pattern has 9 symbols after code): ")
            try:
                ...
                self.interface.bot_print('Incorrect phone number format! Please provide correct phone number format.')
            else:
                break
    ...
    def __init__(self, value=''):
        ...
        while True:
            ...
            try:
                ...
                self.interface.bot_print('Incorrect date! Please provide correct date format.')
    ...
    def __init__(self, value=''):
        ...
        while True:
            ...
            if value:
                ...
                self.value = self.interface.bot_input("Email: ")
            try:
                ...
                self.interface.bot_print('Incorrect email! Please provide correct email.')
    ...
    def __init__(self, value=''):
        ...
        while True:
            ...
            if value:
                ...
                self.value = self.interface.bot_input("Type of relationship (family, friend, work): ")
            try:
                ...
                self.interface.bot_print('There is no such status!')
