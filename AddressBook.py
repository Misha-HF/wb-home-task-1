...
class AddressBook(UserList):
        ...
        for account in self.data:
            ...
            if account['phones']:
                ...
                for phone in account['phones']:
                    self.interface.bot_print(phone)
                    if phone:
    ...
    def search(self, pattern, category):
        ...
        for account in self.data:
            if category_new == 'phones':
                ...
                result.append(account)
        if not result:
            self.interface.bot_print('There is no such contact in address book!')
        return result
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            self.interface.bot_print('Incorrect parameter! Please provide correct parameter')
        except NameError:
            self.interface.bot_print('There is no such contact in address book!')
        else:
